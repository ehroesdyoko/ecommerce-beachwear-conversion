# NOTE: THE FILE IS CENSORED - some of the code might be affected
...
#Import the queried [CENSORED] data ----
...
setwd("C:/Users/nilsd/OneDrive/Documents/Data Engineering/[CENSORED] Assignment")
CustomerConversion <- read.csv("[CENSORED]_Final.csv")
...
# Convert conversion to numeric
actual_session_table$[CENSORED] <- as.numeric(as.character(actual_session_table$[CENSORED]))
...
# Perform the point-biserial correlation test
cor_test_result_[CENSORED] <- cor.test(actual_session_table$[CENSORED], actual_session_table$conversion, method = "pearson")
...
# Display the results
print(cor_test_result_[CENSORED])
